# lecture_supplements_2026
A collection of codes and notebooks to supplement the 2026 ISR summer school lectures.

___

## Using in the Cloud
You can interact with the Jupyter notebooks in this repository using the free server, Binder. [![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/isrsummerschool/lecture_supplements_2026/main)
___
...
**2)** Clone this repository:
    ...
    $ git clone https://github.com/isrsummerschool/lecture_supplements_2026.git

**3)** Install the python packages that the lecture supplement notebooks need:

    $ cd lecture_supplements_2026
...
**4)** Clone this repository:
    ...
    (isrschool) $ git clone https://github.com/isrsummerschool/lecture_supplements_2026.git
    
**5)** Inside the virtual environment install the python packages that the lecture supplement notebooks need:

    (isrschool) $ cd lecture_supplements_2026
